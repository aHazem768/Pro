...
if st.sidebar.checkbox("Справка"):
    ...
    with st.sidebar.expander("Справка:"):
        # Отображение содержимого внутри раскрывающейся кнопки
        st.title("Как работать:")
        st.write("- Выберите свой файл в формате журнала.LOG (Расчет трудоемкости)")
        st.write("- Выберите файлы в формате .csv (Расчет количества элементов)")
        st.write("- Выберите файлы в формате .csv (Спецификации элементов)")
        st.write("- Выберите файлы в формате .rnp (Открыть файл Renga)")
#-----------------------------------------------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------------------------------------------------
